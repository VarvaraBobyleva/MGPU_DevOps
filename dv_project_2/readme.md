...
![Скринкаст работы](./screenshots/demo.mov)
> **Примечание:** Если скринкаст не запускается, вы можете найти его в папке `/screenshots/demo.mov`, а также просмотреть скриншоты дашборда в папке `/screenshots/demo_scren_1.png` и `/screenshots/demo_scren_2.png` этого репозитория.
